...
@Component({
    selector: "compass-ui-change-email",
...
export class ChangeEmailComponent implements OnInit {
    ...
    ngOnInit(): void {
        // TODOAM5 load data (such as first name, last name, and username)
        let firstName= "John"
        let lastName = "Doe"
    ...
    next(): void {
        ...
        // check password TODOAM5 increase attempt count and mark passwordError = true if wrong.
