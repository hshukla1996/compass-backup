...
export class ScreenQueueUtil {
    ...
    getPathName(name: string): string[] {
        return this.getIndividualLegalSituationsGatePost(name);
    }

    getIndividualLegalSituationsGatePost(name: string): string[] {
        switch (name) {
            case ScreenQueueRoutesIndividualLegalSituations.ownesFines:
                return [
                    RoutePath.APPLYNOW_INDIVIDUALDETAILS +
                        "/" +
                        RoutePath.APPLYNOW_INDIVIDUALDETAILS_OWNESFINES,
                ];

            case ScreenQueueRoutesIndividualLegalSituations.convictedWelfareFraud:
                return [
                    RoutePath.APPLYNOW_INDIVIDUALDETAILS +
                        "/" +
                        RoutePath.APPLYNOW_INDIVIDUALDETAILS_CONVICTEDWELFAREFRAUD,
                ];
            case ScreenQueueRoutesIndividualLegalSituations.currentlyOnProbation:
                return [
                    RoutePath.APPLYNOW_INDIVIDUALDETAILS +
                        "/" +
                        RoutePath.APPLYNOW_INDIVIDUALDETAILS_CURRENTLYONPROBATION,
                ];
            case ScreenQueueRoutesIndividualLegalSituations.currentlyFleeing:
                return [
                    RoutePath.APPLYNOW_INDIVIDUALDETAILS +
                        "/" +
                        RoutePath.APPLYNOW_INDIVIDUALDETAILS_CURRENTLYFLEEING,
                ];
            case ScreenQueueRoutesIndividualLegalSituations.isAnyoneCurrentlyIncarcerated:
                return [
                    RoutePath.APPLYNOW_INDIVIDUALDETAILS +
                        "/" +
    ...
    getDefaultRouteQueue() {
        return ApplyNowIndividualLegalSituations;
    }
...
export enum ScreenQueueRoutesIndividualLegalSituations {
    ownesFines = "ownesfines",
    convictedWelfareFraud = "convictedwelfarefraud",
    currentlyOnProbation = "currentlyonprobation",
...
export const ApplyNowIndividualLegalSituations = [
    RoutePath.APPLYNOW_INDIVIDUALDETAILS +
        "/" +
        RoutePath.APPLYNOW_INDIVIDUALDETAILS_OWNESFINES,
