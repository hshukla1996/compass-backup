...
import JsonData from './social-security-disability.json'

@Component({
  selector: 'compass-ui-social-security-disability',
  templateUrl: './social-security-disability.component.html',
  styleUrls: ['./social-security-disability.component.scss'],
})
export class SocialSecurityDisabilityComponent implements OnInit {
    jsonData: any;
    alreadySelected: any[] = [];
    socialSecurityDisabilityForm: FormGroup | any;
    ...
    ngOnInit(): void {
        ...
        this.socialSecurityDisabilityForm = this.fb.group({
        ...
        this.service.getAppData().subscribe(d => {
            ...
            this.alreadySelected = [...this.applyNowState?.householdHasAnyoneReceivedSSDInThePast?.individualNumbers ?? []]; 
